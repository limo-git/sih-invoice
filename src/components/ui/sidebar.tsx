...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-4 py-4 hidden  md:flex md:flex-col bg-black-900 w-[300px] flex-shrink-0",
          className
        )}
        animate={{
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "fixed h-full w-full inset-0 bg-black-900 p-10 z-[100] flex flex-col justify-between",
                className
              )}
            >
              <div

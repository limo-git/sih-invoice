...
const components = {
  ...
  tr: ({ className, ...props }: React.HTMLAttributes<HTMLTableRowElement>) => (
    <tr
      className={cn("m-0 p-0 even:bg-muted", className)}
      {...props}
    />
  ),
...
export const Mdx: React.FC<MdxProps> = ({ code }) => {
  ...
  return (
    ...
    <div className="mdx" style={{display:"flex", flexDirection:"column",justifyContent:"center", width: "60%",borderLeft:"1px solid white",paddingLeft:"2rem"}}>
